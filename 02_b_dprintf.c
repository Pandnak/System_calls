...
// Если такого файла не существует, то он будет создан и в него запишется
// строка.
#include <fcntl.h>
...
int main(int argc, char *argv[]) {
	...
	// opening descriptor with accesses: r/w for user and r only for group and
	// others
	...
	if (dprintf(fd, "%s", argv[2]) <
		0) // return the number of characters printed, without \0.
